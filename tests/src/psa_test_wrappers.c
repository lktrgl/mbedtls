  ...
  size_t* arg10_plaintext_length )
{
  ...
  psa_status_t status = ( psa_aead_decrypt ) ( arg0_key, arg1_alg, arg2_nonce, arg3_nonce_length, arg4_additional_data,
                        arg5_additional_data_length, arg6_ciphertext, arg7_ciphertext_length, arg8_plaintext, arg9_plaintext_size,
                        arg10_plaintext_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_aead_encrypt ) ( arg0_key, arg1_alg, arg2_nonce, arg3_nonce_length, arg4_additional_data,
                        arg5_additional_data_length, arg6_plaintext, arg7_plaintext_length, arg8_ciphertext, arg9_ciphertext_size,
                        arg10_ciphertext_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg2_nonce, arg3_nonce_length );
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg4_additional_data, arg5_additional_data_length );
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_aead_finish ) ( arg0_operation, arg1_ciphertext, arg2_ciphertext_size,
                        arg3_ciphertext_length, arg4_tag, arg5_tag_size, arg6_tag_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_aead_update ) ( arg0_operation, arg1_input, arg2_input_length, arg3_output,
                        arg4_output_size, arg5_output_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_aead_verify ) ( arg0_operation, arg1_plaintext, arg2_plaintext_size, arg3_plaintext_length,
                        arg4_tag, arg5_tag_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_cipher_decrypt ) ( arg0_key, arg1_alg, arg2_input, arg3_input_length, arg4_output,
                        arg5_output_size, arg6_output_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg2_input, arg3_input_length );
  ...
  size_t* arg6_output_length )
{
  ...
  MBEDTLS_TEST_MEMORY_POISON ( arg4_output, arg5_output_size );
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_cipher_encrypt ) ( arg0_key, arg1_alg, arg2_input, arg3_input_length, arg4_output,
                        arg5_output_size, arg6_output_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg2_input, arg3_input_length );
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg4_output, arg5_output_size );
  ...
  size_t* arg5_output_length )
{
  ...
  MBEDTLS_TEST_MEMORY_POISON ( arg3_output, arg4_output_size );
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_cipher_update ) ( arg0_operation, arg1_input, arg2_input_length, arg3_output,
                        arg4_output_size, arg5_output_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg1_input, arg2_input_length );
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg3_output, arg4_output_size );
...
{
  psa_status_t status = ( psa_crypto_driver_pake_get_peer ) ( arg0_inputs, arg1_peer_id, arg2_peer_id_size,
                        arg3_peer_id_length );
  return status;
}
#endif /* defined(PSA_WANT_ALG_SOME_PAKE) */
...
{
  psa_status_t status = ( psa_crypto_driver_pake_get_user ) ( arg0_inputs, arg1_user_id, arg2_user_id_size,
                        arg3_user_id_len );
  return status;
}
#endif /* defined(PSA_WANT_ALG_SOME_PAKE) */
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_generate_key_custom ) ( arg0_attributes, arg1_custom, arg2_custom_data,
                        arg3_custom_data_length, arg4_key );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_hash_compute ) ( arg0_alg, arg1_input, arg2_input_length, arg3_hash, arg4_hash_size,
                        arg5_hash_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg1_input, arg2_input_length );
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_key_derivation_key_agreement ) ( arg0_operation, arg1_step, arg2_private_key, arg3_peer_key,
                        arg4_peer_key_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_key_derivation_output_key_custom ) ( arg0_attributes, arg1_operation, arg2_custom,
                        arg3_custom_data, arg4_custom_data_length, arg5_key );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
...
psa_status_t mbedtls_test_wrap_psa_key_derivation_output_key_ext (
  ...
  mbedtls_svc_key_id_t* arg4_key )
{
  psa_status_t status = ( psa_key_derivation_output_key_ext ) ( arg0_attributes, arg1_operation, arg2_params,
                        arg3_params_data_length, arg4_key );
  return status;
}
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_mac_compute ) ( arg0_key, arg1_alg, arg2_input, arg3_input_length, arg4_mac, arg5_mac_size,
                        arg6_mac_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg2_input, arg3_input_length );
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_mac_verify ) ( arg0_key, arg1_alg, arg2_input, arg3_input_length, arg4_mac,
                        arg5_mac_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg2_input, arg3_input_length );
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_pake_output ) ( arg0_operation, arg1_step, arg2_output, arg3_output_size,
                        arg4_output_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  ...
  size_t* arg6_output_length )
{
  ...
  MBEDTLS_TEST_MEMORY_POISON ( arg4_output, arg5_output_size );
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_raw_key_agreement ) ( arg0_alg, arg1_private_key, arg2_peer_key, arg3_peer_key_length,
                        arg4_output, arg5_output_size, arg6_output_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_sign_hash ) ( arg0_key, arg1_alg, arg2_hash, arg3_hash_length, arg4_signature,
                        arg5_signature_size, arg6_signature_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_sign_hash_complete ) ( arg0_operation, arg1_signature, arg2_signature_size,
                        arg3_signature_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  ...
  size_t* arg6_signature_length )
{
  ...
  MBEDTLS_TEST_MEMORY_POISON ( arg4_signature, arg5_signature_size );
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_sign_message ) ( arg0_key, arg1_alg, arg2_input, arg3_input_length, arg4_signature,
                        arg5_signature_size, arg6_signature_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg2_input, arg3_input_length );
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg4_signature, arg5_signature_size );
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_verify_hash ) ( arg0_key, arg1_alg, arg2_hash, arg3_hash_length, arg4_signature,
                        arg5_signature_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg2_hash, arg3_hash_length );
...
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_verify_hash_start ) ( arg0_operation, arg1_key, arg2_alg, arg3_hash, arg4_hash_length,
                        arg5_signature, arg6_signature_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg3_hash, arg4_hash_length );
  ...
  size_t arg5_signature_length )
{
  ...
  MBEDTLS_TEST_MEMORY_POISON ( arg4_signature, arg5_signature_length );
#endif /* !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS) */
  psa_status_t status = ( psa_verify_message ) ( arg0_key, arg1_alg, arg2_input, arg3_input_length, arg4_signature,
                        arg5_signature_length );
#if !defined(MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS)
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg2_input, arg3_input_length );
  MBEDTLS_TEST_MEMORY_UNPOISON ( arg4_signature, arg5_signature_length );
